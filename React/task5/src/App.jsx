...
function App(){
  return(
    <>
      ...
      />
      <Entry 
      img="../src/assets/australia.png"
      country="AUSTRALIA"
      map="https://maps.app.goo.gl/dhMvgZVcwnhYTF8S9"
      ...
      />
      <Entry 
      img="../src/assets/norway.png"
      country="NORWAY"
      map="https://maps.app.goo.gl/ExuMAGogMAjk4jtF7"
